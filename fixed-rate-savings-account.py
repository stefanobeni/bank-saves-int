...
OBSA_withdrawal_rate = 0  # This is the withdrawal rate. In other words it is the number of months you withdraw
                          # money for in the event that you withdraw.

results = Fixed_Rate(total_savings, year_need, OBSA_withdrawal_rate)

print('The amount in your savings account after a year is '
